            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-blue-50 rounded border border-blue-200">
                  <p className="text-xs text-gray-600 font-semibold">Nombre de factures</p>
                  <p className="text-2xl font-bold text-blue-700 mt-1">
                    {situation.nombreChargesAvecTVA || 0}
                  </p>
                </div>
                <div className="p-3 bg-blue-50 rounded border border-blue-200">
                  <p className="text-xs text-gray-600 font-semibold">Montant HT</p>
                  <p className="text-2xl font-bold text-blue-700 mt-1">
                    {((situation.totalChargesAvecTVA || 0) / 1000).toFixed(1)}k€
                  </p>
                </div>
              </div>
              <div className="p-4 bg-blue-100 rounded-lg border-2 border-blue-300">
                <p className="text-xs text-gray-700 font-semibold">TVA Récupérable</p>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-amber-50 rounded border border-amber-200">
                  <p className="text-xs text-gray-600 font-semibold">Montant HT</p>
                  <p className="text-2xl font-bold text-amber-700 mt-1">
                    {((situation.totalChargesSansTVA || 0) / 1000).toFixed(1)}k€
                  </p>
                </div>
              </div>
              <div className="p-4 bg-amber-100 rounded-lg border-2 border-amber-300">
                <p className="text-xs text-gray-700 font-semibold">Total HT</p>
